...
//    private final static String BASE_URL = "http://share-tdd.com/"; // 개발서버
    ...
    //    페이스북 로그인
    public static void facebook_login(final Context context, String uid, String name, String profile_url, final JsonResponseHandler handler) {
...
//        data.put("password", pw);
    ...
    //    댓글 작성
    public static void register_reply(final Context context, final String user_id, final String content, final JsonResponseHandler handler) {
